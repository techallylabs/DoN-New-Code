...
<form class="campaign-donation" method="post">
	...
	<div class="link-box"><button type="submit" name="charitable_submit" class="donate-button button button-primary theme-btn btn-style-one"><?php esc_attr_e( 'Donate Now', 'loveus' ); ?></button></div>
</form>
