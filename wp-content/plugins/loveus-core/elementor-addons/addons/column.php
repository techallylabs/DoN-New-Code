 ...
 * @since 1.0.0
 */
class Element_Column_loveus extends Element_Base {
...
\Elementor\Plugin::instance()->widgets_manager->register_widget_type( new \Element_Column_loveus() );